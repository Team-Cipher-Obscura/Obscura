...
const REDACTION_LABELS = {
  ...
  cvv_text: "[REDACTED_CVV]",
  card_expiry_text: "[REDACTED_EXPIRY]",
  "autocomplete_cc-number": "[REDACTED_CARD]",
  "autocomplete_cc-exp": "[REDACTED_EXPIRY]",
  "autocomplete_cc-exp-month": "[REDACTED_EXPIRY]",
  "autocomplete_cc-exp-year": "[REDACTED_EXPIRY]",
  "autocomplete_cc-csc": "[REDACTED_CVV]",
  "autocomplete_cc-name": "[REDACTED_CARD]",
  "autocomplete_current-password": "[REDACTED_PASSWORD]",
  "autocomplete_new-password": "[REDACTED_PASSWORD]",
  "autocomplete_one-time-code": "[REDACTED_OTP]",
  "autocomplete_email": "[REDACTED_EMAIL]",
  "autocomplete_tel": "[REDACTED_PHONE]",
};
